...
function EditExpenseModal({ isOpen, onClose, expense, onSuccess, token }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setServerError(error.response?.data?.message || 'Error updating expense');
    }
  };
    ...
    <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
      <div className='bg-white p-6 rounded-lg shadow-lg w-full max-w-md'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='mb-4'>
            <label className='block text-gray-700 mb-1' htmlFor='payment_method'>
              Payment Method
            </label>
            <select
              id='payment_method'
